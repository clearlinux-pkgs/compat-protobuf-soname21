...
Requires: compat-protobuf-soname21-bin = %{version}-%{release}
Requires: compat-protobuf-soname21-lib = %{version}-%{release}
Requires: compat-protobuf-soname21-license = %{version}-%{release}
Requires: compat-protobuf-soname21-python = %{version}-%{release}
Requires: compat-protobuf-soname21-python3 = %{version}-%{release}
Requires: setuptools
Requires: six
...
%package bin
Summary: bin components for the compat-protobuf-soname21 package.
Group: Binaries
Requires: compat-protobuf-soname21-license = %{version}-%{release}

%description bin
bin components for the compat-protobuf-soname21 package.
...
Requires: compat-protobuf-soname21-lib = %{version}-%{release}
Requires: compat-protobuf-soname21-bin = %{version}-%{release}
Provides: compat-protobuf-soname21-devel = %{version}-%{release}
Requires: compat-protobuf-soname21 = %{version}-%{release}
...
%package python
Summary: python components for the compat-protobuf-soname21 package.
Group: Default
Requires: compat-protobuf-soname21-python3 = %{version}-%{release}

%description python
python components for the compat-protobuf-soname21 package.


%package python3
Summary: python3 components for the compat-protobuf-soname21 package.
Group: Default
Requires: python3-core

%description python3
python3 components for the compat-protobuf-soname21 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575565565
